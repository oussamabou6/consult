...
if (isset($_POST['approve_certificate'])) {
    ...
    header("Location: consult_pro.php?id=$profile_id");
    exit;
}
...
<body>
    <div class="container">
        ...
        <div class="main-content">
            ...
            <div class="tab-content active" id="certificates-tab">
                <h3>Certificates <?php echo getStatusBadge($profile['certificates_status']); ?></h3>
                    ...
                    <?php foreach ($certificates as $certificate): ?>
                        <div class="item-card">
                            <div class="item-card-header">
                                <div>
                                    <h4 class="item-card-title"><?php echo htmlspecialchars($certificate['certificate_id']); ?></h4>
                            ...
                            <div class="item-card-body">
                                ...
                                <div class="item-card-description">
                                    ...
                                    <p class="text-danger"><?php echo htmlspecialchars($certificate['rejection_reason']); ?></p>
                                </div>
                                <?php endif; ?>
                            </div>
            ...
            <div class="tab-content" id="experiences-tab">
                <h3>Experiences <?php echo getStatusBadge($profile['experiences_status']); ?></h3>
                
                <?php if (empty($experiences)): ?>
                    <div class="alert alert-info">
                        <i class="fas fa-info-circle"></i>
                        <div>No experiences found for this expert.</div>
                    </div>
                <?php else: ?>
                    <?php foreach ($experiences as $experience): ?>
                        <div class="item-card">
                            ...
                            <div class="item-card-body">
                                ...
                                <div class="item-card-description">
                                    <h4>Rejection Reason</h4>
                                    <p class="text-danger"><?php echo htmlspecialchars($experience['rejection_reason']); ?></p>
                                </div>
                                <?php endif; ?>
                            </div>
                            <div class="item-card-footer">
                    ...
                    <div class="section-actions">
                        ...
                        <form method="post">
                            <button type="submit" name="approve_experiences_section" class="btn btn-success">
                                <i class="fas fa-check-circle"></i> Approve Experiences
                            </button>
                        </form>
            ...
            <div class="tab-content" id="formations-tab">
                <h3>Formations <?php echo getStatusBadge($profile['formations_status']); ?></h3>
                
                <?php if (empty($formations)): ?>
                    <div class="alert alert-info">
                        <i class="fas fa-info-circle"></i>
                        <div>No formations found for this expert.</div>
                    </div>
                <?php else: ?>
                    <?php foreach ($formations as $formation): ?>
                        <div class="item-card">
                            ...
                            <div class="item-card-body">
                                ...
                                <div class="item-card-description">
                                    <h4>Rejection Reason</h4>
                                    <p class="text-danger"><?php echo htmlspecialchars($formation['rejection_reason']); ?></p>
                                </div>
                                <?php endif; ?>
                            </div>
                            <div class="item-card-footer">
                    ...
                    <div class="section-actions">
                        ...
                        <form method="post">
                            <button type="submit" name="approve_formations_section" class="btn btn-success">
                                <i class="fas fa-check-circle"></i> Approve Formations
                            </button>
                        </form>
            ...
            <div class="tab-content" id="banking-tab">
                <h3>Banking Information <?php echo getStatusBadge($profile['banking_status']); ?></h3>
                ...
                <?php else: ?>
                    ...
                    <div class="section-actions">
                    <?php if ($profile['banking_status'] === 'pending_review'): ?>                        <form method="post">
            ...
            <div class="profile-actions">
                <?php if ($profile['status'] === 'pending_review'): ?>
                <form method="post">
    ...
    <div class="modal" id="reject-certificates-section-modal">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">Reject Certificates Section</h3>
                <button type="button" class="modal-close" onclick="closeModal('reject-certificates-section-modal')">&times;</button>
            </div>
            <form method="post">
                <div class="modal-body">
                    <div class="form-group">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" onclick="closeModal('reject-certificates-section-modal')">Cancel</button>
    ...
    <div class="modal" id="reject-experiences-section-modal">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">Reject Experiences Section</h3>
                <button type="button" class="modal-close" onclick="closeModal('reject-experiences-section-modal')">&times;</button>
            </div>
            <form method="post">
                <div class="modal-body">
                    <div class="form-group">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" onclick="closeModal('reject-experiences-section-modal')">Cancel</button>
    ...
    <div class="modal" id="reject-formations-section-modal">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">Reject Formations Section</h3>
                <button type="button" class="modal-close" onclick="closeModal('reject-formations-section-modal')">&times;</button>
            </div>
            <form method="post">
                <div class="modal-body">
                    <div class="form-group">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" onclick="closeModal('reject-formations-section-modal')">Cancel</button>
    ...
    <div class="modal" id="reject-banking-section-modal">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">Reject Banking Information</h3>
                <button type="button" class="modal-close" onclick="closeModal('reject-banking-section-modal')">&times;</button>
            </div>
            <form method="post">
                <div class="modal-body">
                    <div class="form-group">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" onclick="closeModal('reject-banking-section-modal')">Cancel</button>
